    ...
    return (
        <div className='nav'>
            ...
            <nav className='nav-bar-main'>
                ...
                <p id='nav-link'><Link to='resume' spy={true} duration={500} offset={-200} smooth={true} onClick={closeMenu}>Resume</Link></p>
                <p id='nav-link'><Link to='contact' spy={true} duration={500} offset={-150} smooth={true} onClick={closeMenu}>Contact</Link></p>
            </nav>}
        </div>
    )
}
